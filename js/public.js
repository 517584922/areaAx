window.onload = function () {
   ...
   /*     var doubleBtn33 = document.getElementById("doubleBtn33").getElementsByTagName("span");
        ...
        //东区 灯光预设
        var doubleBtn39 = document.getElementById("doubleBtn39").getElementsByTagName("span");
        btnAct(doubleBtn39,largeAct);
        //东区 设备控制
        var doubleBtn40 = document.getElementById("doubleBtn40").getElementsByTagName("span");
        btnAct(doubleBtn40,btnActive);
/*        //东区
        var doubleBtn38 = document.getElementById("doubleBtn38").getElementsByTagName("span");
        btnAct(doubleBtn38,btnActive);
        //东区
